 ...
 * @copyright IGN
 ******************************************************************************/
package fr.ign.cogit.geoxygene.contrib.multicriteriadecision.classifying;
 ...
 * 
 *         L'enjeu du diagnostic est de définir à quelle catégorie de qualité
 *         appartient le jeu de K courant Nous avons pour cela défini 5 qualités
 *         de connaissances (chap. E) Pour chaque critère, l'ensemble des
 *         valeurs pouvant être pris par ce critère (compris entre 0 et 1) est
 *         divisé en intervalle 0 : intervalle "très mauvais" :intervalle
 *         "mauvais" : intervalle "moyen" : intervalle "bon" : intervalle
 *         "très bon" : 1
 */
public class ConclusionIntervals {
   ...
   *                     "this$0:fr.ign.cogit.generalisation.lib.gestionConnaissances.diagnostic.decisionmulticritere.conclusion.ConclusionIntervalles$Intervalle"
   */
  ...
  public ConclusionIntervals(List<Interval> intervals,
