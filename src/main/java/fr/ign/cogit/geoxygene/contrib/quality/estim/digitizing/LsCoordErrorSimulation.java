 ...
 * @author JFGirres
 */
public class LsCoordErrorSimulation extends AbstractErrorSimulation<GM_LineString> {

    public LsCoordErrorSimulation() {
    }

    /**
     * A basic method to simulate digitizing error (by determining the offset
     * distance in X and Y with a gaussian distribution). Extremity nodes are
     * simulated first, then points of the polyline are simulated after.
     * @author JFGirres
     */
    @Override
